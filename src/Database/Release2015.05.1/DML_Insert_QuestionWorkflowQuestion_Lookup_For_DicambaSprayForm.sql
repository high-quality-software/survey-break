...
select top 5 * from Question order by Question_ID desc
--Question
begin tran
...
--update question
UPDATE Question SET IsLookup = 1 WHERE Question_ID IN (98,99,102,103,104,105,106,109,110,113,117,122,129,132,133,134,135,136,139,140,142,146,151) and IsLookup = 0 
